...
# dataset -----------------------
_C.DATA.BASEDIR = r'/media/koby_a/Data/databases/coco'  # /path/to/your/COCO/DIR'
...
_C.DATA.NUM_CATEGORY = 3    # 3 categories.
_C.DATA.CLASS_NAMES = ['BG', 'tank', 'car', 'person']  # NUM_CLASS (NUM_CATEGORY+1) strings, to be populated later by data loader. The first is BG.

# validation datasets (added for koby) -----------------------
_C.VAL_DATA.BASEDIR = {'coco': r'/media/koby_a/Data/databases/coco',
                       'open_images': r'/media/koby_a/Data/databases/open_images'}
_C.VAL_DATA.NAMES = {'coco': ['val2014'], 'open_images': ['validation', 'test']}

# basemodel ----------------------
_C.BACKBONE.WEIGHTS = r'/home/koby_a/tensorflow/trained_models_tensorpack/ImageNet-ResNet50/ImageNet-ResNet50.npz'   # /path/to/weights.npz
...
_C.TRAIN.WARMUP = 1000   # 1000  # in terms of iterations. This is not affected by #GPUs
...
# testing -----------------------
_C.TEST.FRCNN_NMS_THRESH = 0.3  # previous value = 0.5
_C.TEST.RESULT_SCORE_THRESH = 1e-4
_C.TEST.RESULT_SCORE_THRESH_VIS = 0.5   # only visualize confident results , previous value = 0.3
